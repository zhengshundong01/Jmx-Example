...
public class DynamicMBeanJmx implements DynamicMBean {

    private MBeanInfo mBeanInfo = null;

    public DynamicMBeanJmx () {
        ...
        operations[0] = new MBeanOperationInfo("sayHello", "methods desc", null, "void", MBeanOperationInfo.INFO);
